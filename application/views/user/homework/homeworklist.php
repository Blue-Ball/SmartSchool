...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-flask"></i> <?php echo $this->lang->line('exam'); ?>
        </h1>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-info"><div class="box-header ptbnull">
                    ...
                    <div class="box-body table-responsive">
                        <div > <div class="download_label"><?php echo $this->lang->line('exam'); ?></div>
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('start') . " " . $this->lang->line('date'); ?></th>
                                        <th><?php echo $this->lang->line('end') . " " . $this->lang->line('date'); ?></th>
                                        <th><?php echo $this->lang->line('submission') . " " . $this->lang->line('date') . " " . $this->lang->line('student'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($homeworklist as $key => $homework) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateYYYYMMDDtoStrtotime($homework['submit_assignment_date'])); ?></td>
                                            <td><?php
                                                $evl_date = "";
                                                if ($homework['evaluationdate'] != "0000-00-00") {
                                            ...
                                            <td>
                                                ...
                                                if ($homework["homework_evaluation_id"] != 0) {                                                    
                                                    if(!empty($homework["student_point"]) && !empty($homework["grade_point"]) && 
                                                        $homework["student_point"] >= $homework["grade_point"]
                                                    ){
                                                        $h_status = 1;
                                                    }
                                            ...
                                            <td class="mailbox-date pull-right">
                                                <?php 
                                                if($h_status==0){ ?>
                                                    <a onclick="upload_docs('<?php echo $homework['id']; ?>', '<?php echo $upload_docsButton; ?>');" class="btn btn-default btn-xs"    data-toggle="tooltip"  data-original-title="<?php echo $this->lang->line('exam') . " " . $this->lang->line('assignments'); ?>">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('details'); ?></h4>
            </div>
...
<div class="modal fade" id="upload_docs" tabindex="-1" role="dialog" aria-labelledby="evaluation" style="padding-left: 0 !important">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('assignments'); ?></h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="teacher_message"><?php echo $this->lang->line('teacher_note'); ?></label>
                                <textarea type="text" id="teacher_message" name="teacher_message" disabled class="form-control ">
...
<script type="text/javascript">
    ...
    function evaluation(id, status) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>user/exam/homework_detail/' + id + '/' + status,
            success: function (data) {
        ...
        $.ajax({
            ...
            success: function (res)
            {
                ...
                if (res.status == 0) {
                    ...
                    $('#teacher_message').val(res.result.teachernote);
                }
