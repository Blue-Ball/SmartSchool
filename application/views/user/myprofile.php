...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      ?>
      <?php
      foreach ($exam_notifications as $notice_key => $notice_value) {
      ?>
         <div class="dashalert alert alert-success alert-dismissible" role="alert">
            <button type="button" class="alertclose close close_notice stualert" data-dismiss="alert" aria-label="Close" data-noticeid=""><span aria-hidden="true">&times;</span></button>
            <a href="<?php echo site_url('user/exam') ?>">
               Hello (<?php echo $this->customlib->getFullname($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?>), 
               you have <?php echo $notice_value['cnt']; ?> 
               exam subject <?php echo $notice_value['subject_name']; ?>.
            </a>
         </div>
      <?php
      }
      ?>
      <?php 
      if($fee_notifications[0]['unpaid_fee_cnt'] > 0){ ?>
         <div class="dashalert alert alert-success alert-dismissible" role="alert">
            <button type="button" class="alertclose close close_notice stualert" data-dismiss="alert" aria-label="Close" data-noticeid=""><span aria-hidden="true">&times;</span></button>
            <a href="<?php echo site_url('user/exam') ?>">
               Hello (<?php echo $this->customlib->getFullname($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?>), 
               you have <?php echo $fee_notifications[0]['unpaid_fee_cnt']; ?> payment you pay off.
            </a>
         </div>
      <?php } ?>
      <div class="row">
