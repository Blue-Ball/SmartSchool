                                    ...
                                    <tbody>
                                       ...
                                       ?>
                                          <tr>
                                             ...
                                             <td>
                                                <?php if($exam_row['evaluation_status'] != "Incomplete") { ?>
                                                   <label class="label label-success"><?php echo $this->lang->line('complete');//pass ?></label>
                                                <?php } else {?>
                                                   <label class="label label-danger"><?php echo $this->lang->line('incomplete');//fail ?></label>
                                                <?php } ?>
                                             </td>                                                      
