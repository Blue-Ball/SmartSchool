        ...
        <?php } ?>
            ...
            if ($this->module_lib->hasActive('homework')) {
                if (($this->rbac->hasPrivilege('homework', 'can_view'))) {
                    ?>
                    <!-- For Homework -->
                    <li class="treeview <?php echo set_Topmenu('Homework'); ?> deleted">
                        <a href="#">
                    ...
                    <!-- For Exam -->
                    <li class="treeview <?php echo set_Topmenu('Exam'); ?>">
                        <a href="#">
                            <i class="fa fa-flask ftlayer"></i> <span><?php echo $this->lang->line('exam'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                    <?php if ($this->rbac->hasPrivilege('homework', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('addexam'); ?>"><a href="<?php echo base_url(); ?>exam"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam_add'); ?></a></li>
                        <li class="<?php echo set_Submenu('examevaluation'); ?>"><a href="<?php echo base_url(); ?>exam/evaluationlist"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam_evaluation'); ?></a></li>
                        <li class="<?php echo set_Submenu('examtype'); ?>"><a href="<?php echo base_url(); ?>examtype"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam_type'); ?></a></li>
                        <li class="<?php echo set_Submenu('examgrade'); ?>"><a href="<?php echo base_url(); ?>examgrade"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam_grade'); ?></a></li>
                        <li class="<?php echo set_Submenu('examreport');  ?>">
                            <a href="#">
                                <i class="fa fa-angle-double-down"></i>
                                <?php echo $this->lang->line('exam_report'); ?>
                                <ul class="treeview-menu">
                                    <li class="<?php echo set_SubSubmenu('examreport_bygroupsubject'); ?>"><a href="<?php echo base_url(); ?>exam/report/bygroupsubject"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam_report_bygroupsubject'); ?></a></li>
                                    <li class="<?php echo set_SubSubmenu('examreport_bysubject'); ?>"><a href="<?php echo base_url(); ?>exam/report/bysubject"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('exam_report_bysubject'); ?></a></li>
                                </ul>
                            </a>
                        </li>
                    <?php } ?>
