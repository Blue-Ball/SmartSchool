                    ...
                    <div class="col-lg-5 col-md-3 col-sm-2 col-xs-5">
                        <span href="#"  class="sidebar-session">
                            <?php //echo $this->setting_model->getCurrentSchoolName();
                                ...
                                $nav_title .= $userdata['user_type'];
                                $nav_title .= " - " . $this->customlib->getAdminSessionUserName(); 
                                echo $nav_title;
                            ?>
                        </span>
                    </div>
            ...
            ?>
                                ...
                                if ($this->module_lib->hasActive('chat')){
                                    if($this->rbac->hasPrivilege('chat','can_view')){
                                        ?>
                                         <li class="cal15">
                                            <a data-placement="bottom" data-toggle="tooltip" title="" href="<?php echo base_url()?>admin/chat" data-original-title="<?php echo $this->lang->line('chat')?>" class="todoicon"><i class="fa fa-whatsapp"></i>
                                            </a>
                                            <?php
