                    ...
                    <div class="col-lg-5 col-md-3 col-sm-2 col-xs-4">   
                        <span href="#" class="sidebar-session">                           
                            ...
                            if($this->customlib->getUserRole() == 'student'){
                               $nav_title .= $this->lang->line("student");
                            }elseif($this->customlib->getUserRole() == 'parent'){
                               $nav_title .= $this->lang->line("parent");
                            }
                            $nav_title .= " - " . $this->customlib->getStudentSessionUserName(); 
                            echo $nav_title;
                            ?>
                        </span>
                    </div>   
...
if($this->studentmodule_lib->hasActive('multi_class')){
 ...
 ?>
                                ...
                                ?>
                                <li class="cal15">
                                    <a data-placement="bottom" data-toggle="tooltip" title="" href="<?php echo base_url()?>user/chat" data-original-title="<?php echo $this->lang->line('chat');?>" class="todoicon">
                                        <i class="fa fa-whatsapp"></i>
                                        <?php
                                        $chat_cnt = $this->customlib->countTotalUnreadChat();                                        
                                        if ($chat_cnt) {
                                            ?>
            ...
            <aside class="main-sidebar" id="alert2">               
                <section class="sidebar"> 
                    ...
                    <ul class="sidebar-menu verttop38" id="sibe-box">
                        <li class="<?php echo set_Topmenu('Dashboard'); ?>"><a href="<?php echo base_url(); ?>user/user/dashboard"><i class="fa fa-tachometer  ftlayer"></i> <span><?php echo $this->lang->line('dashboard'); ?></span></a></li>

                        <li class="<?php echo set_Topmenu('myprofile'); ?>"><a href="<?php echo base_url(); ?>user/user/myprofile"><i class="fa fa-user-plus ftlayer"></i> <span><?php echo $this->lang->line('my_profile'); ?></span></a></li>
                        ...
                        if ($this->studentmodule_lib->hasActive('homework')) {
                            ...
                            <li class="<?php echo set_Topmenu('Homework'); ?>">
                                <a href="<?php echo base_url(); ?>user/exam">
                                    <i class="fa fa-flask ftlayer"></i> <span><?php echo $this->lang->line('exam'); ?></span>
                                    <?php
                                    $cnt = $this->customlib->getIncompletedExam();
                                    if ($cnt) {
                                        ?>
                                        <small class="label pull-right bg-red" style="margin-top: -7px;">
                                            <?php echo $cnt; ?>
