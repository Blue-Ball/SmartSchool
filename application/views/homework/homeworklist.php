...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <form  class="assign_teacher_form" action="<?php echo base_url(); ?>exam/" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('exam_list'); ?></h3>
                                        ...
                                        foreach ($homeworklist as $key => $homework) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    echo mb_substr(strip_tags($homework['description']), 0, 25) . '...';
                                                    // }
                                                    ?></td>
                                                <td><?php
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('exam')." ".$this->lang->line('name'); ?></label>
