...
<div class="col-lg-12">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-3 control-label"> <?php echo $this->lang->line('upload_proof_file') ?></label>
            <div class="col-sm-9">
                <div class="prooffile">
                <input class="filestyle form-control" type="file" name="prooffile" id="prooffile" size="20" autocomplete="off">
