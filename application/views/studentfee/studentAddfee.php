            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Date <small class="req"> *</small></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label"> Proof of Payment</label>
                                <div class="col-sm-9">
                                    <div class="prooffile">
                                        <input name="prooffile" id="prooffile" class="filestyle form-control" type="file" size="20" autocomplete="off">
                                        <span id="form_collection_fee_gupcollected_file_error" class="text text-danger"></span>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).on('click', '.collectSelected', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    //loadjscssfile("<?php echo base_url(); ?>backend/dist/css/dropify.min.css", "css");
                    $("#listCollectionModal .modal-body .list").html(data.view);
