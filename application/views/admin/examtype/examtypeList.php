...
<div class="content-wrapper" style="min-height: 946px;">  
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="col-md-4">          
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_examtype'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('examtype') ?>"  id="examtypeform" name="examtypeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="examtypename" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name'); ?>" />
            ...
            if ($this->rbac->hasPrivilege('examtype', 'can_add')) {
                echo "8";
            } else {
                echo "12";
            }
