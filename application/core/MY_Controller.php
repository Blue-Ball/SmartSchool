...
class MY_Controller extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('setting_model', 'customfield_model', 'onlinestudent_model', 'houselist_model', 'onlineexam_model', 'onlineexamquestion_model', 'onlineexamresult_model', 'examstudent_model', 'admitcard_model', 'marksheet_model', 'chatuser_model', 'examgroupstudent_model', 'examgroup_model', 'batchsubject_model', 'examtype_model', 'examgrade_model', 'history_model'));
        ...
        if($user_role != ""){
            ...
            if ($user_role == "student") {
                $login_user_id             = $this->customlib->getStudentSessionUserID();                
            }else{
                $userdata = $this->customlib->getUserData();
                $login_user_id             = $userdata['id'];
            }

            $history = $this->history_model->getHistory($login_user_id, $user_role);
            $data = array();
            ...
            $this->history_model->setHistory($data);
        }      
...
class Admin_Controller extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('batchsubject_model', 'examgroup_model', 'examsubject_model', 'examgroupstudent_model', 'feereminder_model','filetype_model','examtype_model', 'examgrade_model'));
